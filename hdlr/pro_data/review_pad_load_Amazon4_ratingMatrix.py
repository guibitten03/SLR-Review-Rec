...
if __name__ == '__main__':
    ...
    data_train = pd.read_csv("../../dataset/Yelp_data/train/Train.csv")
    data_test = pd.read_csv("../../dataset/Yelp_data/test/Test.csv")
