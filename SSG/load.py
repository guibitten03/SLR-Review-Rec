...
data = pd.read_csv("../dataset/Digital_Music_data/data.csv")
...
tp_1 = pd.read_csv("../dataset/Digital_Music_data/test/Test.csv")
tp_train = pd.read_csv("../dataset/Digital_Music_data/train/Train.csv")
tp_valid = pd.read_csv("../dataset/Digital_Music_data/val/Val.csv")
